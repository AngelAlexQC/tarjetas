...
describe('EmailLoginScreen', () => {
  ...
  describe('Validaciones', () => {
    ...
    it('should show error when email is invalid', async () => {
      const { getByPlaceholderText, getByText, queryByText } = render(<EmailLoginScreen {...mockProps} />);
      ...
      await waitFor(() => {
        expect(queryByText('Ingresa un correo electrónico válido')).toBeTruthy();
      });
    });
  ...
  describe('Flujo de Login', () => {
    ...
    it('should handle unexpected errors during login', async () => {
      ...
      await waitFor(() => {
        expect(queryByText('Error inesperado. Intenta de nuevo.')).toBeTruthy();
      });
    });
  });
  ...
  describe('Lógica del Hook (Unit Tests)', () => {
    it('should validate empty email', async () => {
      ...
      // El hook usa setError, no Alert.alert
    ...
    it('should validate empty password', async () => {
      ...
      // El hook usa setError, no Alert.alert
      expect(result.current.error).toBe('Ingresa tu contraseña');
    });
  });
