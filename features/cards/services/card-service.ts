/**
 * Card Service - DEPRECATED
 * 
 * ⚠️ ESTE ARCHIVO ESTÁ DEPRECADO Y SERÁ ELIMINADO EN FUTURAS VERSIONES
 * 
 * El patrón de servicio síncrono no es adecuado para consumir APIs.
 * Todas las operaciones de datos deben ser asíncronas.
 * 
 * Para nuevas funcionalidades, usa:
 * - useCards() hook de @/hooks/use-cards (RECOMENDADO para componentes React)
 * - cardRepository$() de @/repositories (para lógica fuera de componentes)
 * 
 * Ambas opciones proveen acceso asíncrono y son compatibles con APIs reales.
 * 
 * @deprecated NO USAR en código nuevo. Migrar código existente a useCards()
 */
